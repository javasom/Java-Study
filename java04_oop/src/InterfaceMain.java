...
//인터페이스를 상속(implements)받아 모든 추상 메소드를 오버라이딩해야 한다.
//			  여러 개를 상속받을 수 있다.
public class InterfaceMain implements InterfaceTest, InterfaceA{
	...
	public static void main(String[] args) {
		...
		//하위 클래스를 객체로 만들어 상위 interface로 대입
		
		InterfaceTest it  = new InterfaceMain();
		// add(), minus(), multiple():숨김, divide():숨김
		System.out.println("add->"+ it.add(5, 10));
		//System.out.println("multiple->"+ it.multiple());
		
		InterfaceMain im2= (InterfaceMain)it;
