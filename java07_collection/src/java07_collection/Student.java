...
public class Student extends Object{
	//캡슐화된 변수
	private int grade; // 0
	private String name; // null	//getUserName
	private String tel;
	private int kor;
	...
	public Student(int grade, String name, String tel, int kor, double eng, int math){
		//new Student(2,"홍길동", "010-2345-3245", 60,25.3 50);
		this.grade = grade;	
		this.name = name;	  
		this.tel = tel;
		this.kor = kor;
	...
	//클래스외부로 값을 내보내는 메소드 : getter() 앞글자는 대문자
	public int getGrade() {
		//기능구현
		return grade;
	}
	//클래스 외부에서 값을 변경할 수 있는 메소드 : setter() 앞글자는 대문자
