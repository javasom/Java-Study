...
public class ArraysTest {
	...
	public static void main(String[] args) {
		...
		int data[] = {52,12,95,78,45,19,52,32};
		...
		Arrays.sort(data3);
		System.out.println("data3 정렬 후 ->"+ Arrays.toString(data3));
		
		//내림차순으로 정렬(문자데이터)
		Arrays.sort(data3, Collections.reverseOrder());
		System.out.println("data3 내림차순->"+ Arrays.toString(data3));
		
		//배열복사
		//	0	1	2	3	4	5	6	7	8
		// [52, 86, 41, 75, 95, 15, 93, 46, 25]
